...
function LogoSection(){
    ...
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        <p className={styles.text__name}>牛窓海</p>
        <p className={styles.text__sub}>日本のエーゲ海</p>
      </div>
    </div>
    )
}
